    ...
    render(){
        return(
            ...
            <React.Fragment>
                ...
                {/* Start Pagehelmet  */}
                <PageHelmet pageTitle='Front-End Development' />
                {/* End Pagehelmet  */}
                {/* <div style={{backgroundColor: '#ffffff', width: '100%', height: '100%'}}> */}
                <LeoHeader2 homeLink="/" logo="symbol-dark" color="color-black" />
                {/* </div> */}
                {/* <Header headertransparent="header--transparent" colorblack="color--black" logoname="logo.png" /> */}

                {/* Start Breadcrump Area */}
                <div className="rn-page-title-area pt--120 pb--190 bg-front-end"  data-black-overlay="5">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 className="title theme-gradient">Front-End Development</h2>
