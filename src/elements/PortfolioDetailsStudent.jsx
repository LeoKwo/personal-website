                                    ...
                                    <div className="inner">
                                        ...
                                        <div className="portfolio-view-list d-flex flex-wrap">
                                            ...
                                            <div className="port-view">
                                                ...
                                                <h5>Spring Boot</h5>
                                                <h5>Spring MVC</h5>
                                                <h5>Spring Data JPA (Hibernate)</h5>
                                        ...
                                        <div className="portfolio-share-link mt--20 pb--70 pb_sm--40">
                                            <ul className="social-share rn-lg-size  justify-content-start liststyle mt--15">
                                                ...
                                                <li><img src="/assets/images/custom/student-1.png"></img></li>
                                                <li><img src="/assets/images/custom/student-2.png"></img></li>
                                                <li><img src="/assets/images/custom/student-3.png"></img></li>
                                                <li><img src="/assets/images/custom/student-4.png"></img></li>
...
export default withTheme(PortfolioDetailsStudent);
